...
const BCA = () => {
    ...
    const ageData = {
        ...
        datasets: [
            {
                label: 'Physical',
                data: [30, 35, 32, 28, 25,43],
                borderColor: '#FF6384',
                fill: false,
            },
            {
                label: 'Environmental',
                data: [25, 30, 28, 25, 20,26],
                borderColor: '#36A2EB',
                fill: false,
            },
            {
                label: 'Psychological',
                data: [28, 32, 30, 30, 28,60],
                borderColor: '#FFCE56',
                fill: false,
            },
            {
                label: 'Social',
                data: [32, 28, 25, 28, 30,40],
                borderColor: '#4BC0C0',
                fill: false,
            },
        ],
    ...
    return (
        <div className="container mx-auto p-6" style={{ paddingTop: '100px' }}>
            <h1 className="text-3xl font-bold mb-6">Overall Health of BCA Students</h1>
