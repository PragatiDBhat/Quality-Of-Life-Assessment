...
const Select = () => {
  return (
    <div className='my-24 md:px-12 px-4 max-w-screen-2xl p-4 mx-auto mt-24' id='explore' style={{ paddingTop: '50px' }}>
        ...
        <div className='container'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
            <motion.div 
              ...
              className='card'
              style={{ maxWidth: '500px', margin: 'auto', display: 'flex', flexDirection: 'column', alignItems: 'center' }} // Adjust size and centering
            >
              <img src={teacher} alt='' style={{ maxWidth: '80%', height: '60%' }} />
              <h5 className='text-3xl font-semibold text-primary px-5 mt-5'>
                Lecturer
              </h5>
              <p className='text-xl px-5  py-4  mt-2'>
                Get started and check your quality of life.
              </p>
              <Link to='/loginteacher' className='btnPrimary1 mt-auto'>Login</Link>
            </motion.div>
            <motion.div 
            ...
            >
              ...
              <p className='text-xl px-5 py-4 mt-2 justify-center'>
                Know your quality of life and improve your way of living for a healthy future.
              </p>
              <Link to='/login' className='btnPrimary1 mt-auto'>Login</Link>
            </motion.div>
          </div>
        </div>
      </div>
