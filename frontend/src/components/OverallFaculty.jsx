...
const OverallFaculty = () => {
    ...
    useEffect(() => {
        const fetchOverallData = async () => {
            try {
                const response = await axios.get('http://localhost:8080/average-teacher-scores');
    ...
    useEffect(() => {
        const fetchGenderData = async () => {
            try {
                const response = await axios.get('http://localhost:8080/teacher-gender-wise-average-scores');
    ...
    useEffect(() => {
        const fetchTypeData = async () => {
            try {
                const response = await axios.get('http://localhost:8080/teacher-university-role-wise-average-scores');
        ...
        datasets: [
            {
                label: 'Teaching',
                data: [
                    typeWise && typeWise.teaching ? typeWise.teaching.averagePh : 0,
                    typeWise && typeWise.teaching ? typeWise.teaching.averageEh : 0,
                    typeWise && typeWise.teaching ? typeWise.teaching.averageMh : 0,
                    typeWise && typeWise.teaching ? typeWise.teaching.averageSh : 0
                ],
            ...
            },
            {
                label: 'Non-teaching',
                data: [
                    typeWise && typeWise.nonteaching ? typeWise.nonteaching.averagePh : 0,
                    typeWise && typeWise.nonteaching ? typeWise.nonteaching.averageEh : 0,
                    typeWise && typeWise.nonteaching ? typeWise.nonteaching.averageMh : 0,
                    typeWise && typeWise.nonteaching ? typeWise.nonteaching.averageSh : 0
                ],
            ...
            },
            {
                label: 'Office Staff',
                data: [
                    typeWise && typeWise.officestaff ? typeWise.officestaff.averagePh : 0,
                    typeWise && typeWise.officestaff ? typeWise.officestaff.averageEh : 0,
                    typeWise && typeWise.officestaff ? typeWise.officestaff.averageMh : 0,
                    typeWise && typeWise.officestaff ? typeWise.officestaff.averageSh : 0
                ],
    ...
    useEffect(() => {
        const fetchAgeGroupData = async () => {
            try {
                const response = await axios.get('http://localhost:8080/teacher-average-scores-by-age-group');
    ...
    return (
        <div className="container mx-auto p-6" style={{ paddingTop: '100px' }}>
            ...
            <div className="card1 bg-white p-6 rounded-lg shadow-md mt-6">
                <h2 className="text-xl font-bold mb-4">Domain Scores by Employee Type</h2>
